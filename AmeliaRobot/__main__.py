...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/329647a798cccb101aecf.jpg), ɪᴍ Charlie ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ Charlie ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/CharlieGroup_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="Charlie_"),
        InlineKeyboardButton(
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` Charlie [🙋‍♀️](https://telegra.ph/file/329647a798cccb101aecf.jpg)
...
def amelia_about_callback(update, context):
    ...
    if query.data == "amelia_":
        query.message.edit_text(
            text=""" ℹ️ I'm *charlie*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://t.me/Uchihasasuke7890).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *charlie*
                 \nHere is the [Source Code](https://t.me/Uchihasasuke7890) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(amelia_about_callback, pattern=r"charlie_")
